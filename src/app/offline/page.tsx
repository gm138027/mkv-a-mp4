...
export default function OfflinePage() {
  return (
    <SiteShell locale="es" messages={esMessages as any}>
      <div className="offline-page">
        <div className="offline-page__container">
          ...
          <p className="offline-page__description">
            It looks like you&apos;ve lost your internet connection. This page requires an active connection to work
            properly.
          </p>

          <div className="offline-page__actions">
            <button onClick={() => window.location.reload()} className="offline-page__button offline-page__button--primary">
              Try Again
            </button>
