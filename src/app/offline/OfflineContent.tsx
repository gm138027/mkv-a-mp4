...
export const OfflineContent = ({ strings }: OfflineContentProps) => {
  const handleRetry = () => {
  ...
  return (
    <div className="offline-page">
      <div className="offline-page__container">
        ...
        <h1 className="offline-page__title">{strings.title}</h1>

        <p className="offline-page__description">{strings.description}</p>
        ...
        <div className="offline-page__tips">
          <h2 className="offline-page__tips-title">{strings.tipsTitle}</h2>
          <ul className="offline-page__tips-list">
            {strings.tips.map((item, index) => (
